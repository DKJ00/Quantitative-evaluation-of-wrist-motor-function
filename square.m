...
Data = importdata("E:\OneDrive - mail.ustc.edu.cn\LABVIEW\实验数据0112\02\0201.csv");
data_1 = Data(:,1:2);
[M,N] = size(data_1);
...
axis equal;
axis off;
print(gcf, 'E:\OneDrive - mail.ustc.edu.cn\LABVIEW\实验数据0112\02\0201.bmp','-r600','-dbmp');
figure;plot(x,y,'r');
axis equal;
ylim([-0.055 0.055]);
xlim([-0.055 0.055]);
...
plot(line_E,'r');
print(gcf, 'E:\OneDrive - mail.ustc.edu.cn\LABVIEW\实验数据0112\02\v_0201.bmp','-r600','-dbmp')
%%
%平均轨迹偏差值及重合度
num_similar = 0;
distance = [];
...
%%
I  = imread("E:\OneDrive - mail.ustc.edu.cn\LABVIEW\实验数据0112\02\0201.bmp");
...
figure;imshow(I_out);
imwrite(I_out,'E:\OneDrive - mail.ustc.edu.cn\LABVIEW\实验数据0112\02\0201_out.bmp');
%%
%结果输出
fprintf('峰值点数量：%d\n',numofpks);
fprintf('平均速度：%d\n',V_avg);
